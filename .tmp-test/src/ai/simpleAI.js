...
exports.nextAIPaddleY = nextAIPaddleY;
const constants_1 = require("../game/constants");
function nextAIPaddleY(ball, ai, field, cfg, rightPaddleX) {
    ...
    targetY = Math.max(constants_1.ARENA.PADDING_TOP, Math.min(field.height - constants_1.ARENA.PADDING_BOTTOM - ai.height, targetY));
