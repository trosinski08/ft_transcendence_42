...
exports.MESSAGES = exports.DEFAULT_LANG = void 0;
exports.isLang = isLang;
exports.t = t;
exports.applyTranslations = applyTranslations;
exports.DEFAULT_LANG = 'pl';
exports.MESSAGES = {
    pl: {
        'nav.home': 'Home',
...
function t(lang, key, vars) {
    const dict = exports.MESSAGES[lang] || exports.MESSAGES[exports.DEFAULT_LANG];
    let s = dict[key] ?? exports.MESSAGES.en[key] ?? key;
    if (vars) {
...
function applyTranslations(root, lang) {
    const dict = exports.MESSAGES[lang] || exports.MESSAGES[exports.DEFAULT_LANG];
    const fallback = exports.MESSAGES.en;
    const nodes = (root instanceof Document ? root : root.ownerDocument).querySelectorAll('[data-i18n]');
    nodes.forEach((el) => {
